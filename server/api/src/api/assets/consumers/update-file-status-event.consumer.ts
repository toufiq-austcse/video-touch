...
import { UpdateFileStatusEventModel } from '@/src/api/assets/models/job.model';
...
export class UpdateFileStatusEventConsumer {
  ...
  public async handle(msg: UpdateFileStatusEventModel) {
    try {
      ...
      await this.fileService.updateFileStatus(msg.asset_id.toString(), msg.height, msg.status, msg.details, msg.dir_size);
    } catch (e: any) {
