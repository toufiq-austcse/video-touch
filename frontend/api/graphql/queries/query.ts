...
query($id:String!){
  GetAsset(getAssetInputDto:{_id:$id}){_id,title,height,width,duration,description,status_logs{status,details,created_at},size,source_url,tags,created_at,updated_at,thumbnail_url,latest_status}
}
`;
